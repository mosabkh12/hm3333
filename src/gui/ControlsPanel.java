...
public class ControlsPanel extends JPanel implements ActionListener{
    ...
    private final JComboBox<String> CompArenaWeather;
    ...
    public ControlsPanel(ArenaPanel arenaPanel) {
        ...
        add(cmbArenaWeather);
        cmbArenaWeather.setLocation(10,110);
        cmbArenaWeather.setSize(145,20);

        JLabel l100 = new JLabel("Season:");
        l100.setLocation(10,128);
        l100.setSize(170, 15);
        add(l100);

       CompArenaWeather = new JComboBox<>();
       CompArenaWeather.addItem("Winter");
       CompArenaWeather.addItem("Summer");


        if (arenaPanel.getWeather() != null)
        	CompArenaWeather.setSelectedItem(arenaPanel.getWeather());
        else
        	CompArenaWeather.setSelectedItem("Sunny");

        add(CompArenaWeather);
        CompArenaWeather.setLocation(10,143);
        CompArenaWeather.setSize(145,20);
        ...
        l15.setLocation(10,560);
        l15.setSize(150, 15);
        add(l15);

        tfMaxSpeed = new JTextField("");
        tfMaxSpeed.setLocation(10,574);
        tfMaxSpeed.setSize(145, 25);
        add(tfMaxSpeed);

        JLabel l16 = new JLabel("Acceleration");
        l16.setLocation(10,595);
        l16.setSize(150, 15);
        add(l16);

        tfAcceleration = new JTextField("");
        tfAcceleration.setLocation(10,610);
        tfAcceleration.setSize(145, 25);
        add(tfAcceleration);
        // Add a label and text field for Competitor ID
        JLabel l17 = new JLabel("Competitor ID");
        l17.setLocation(10,635);
        l17.setSize(150, 15);
        add(l17);

        JTextField tfCompetitorID = new JTextField("");
        tfCompetitorID.setLocation(10,650);
        tfCompetitorID.setSize(145, 25);
        add(tfCompetitorID);



        JButton addCompetitorBut = new JButton("Add competitor");
        addCompetitorBut.setLocation(10,670);
    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()) {
				...
				case "Build arena":
                    ...
                    if ("Summer".equals(CompArenaWeather.getSelectedItem())) {
                         JOptionPane.showMessageDialog(this, "Summer arena is not available right now.", "Invalid Selection", JOptionPane.WARNING_MESSAGE);
                         return;
                    }
